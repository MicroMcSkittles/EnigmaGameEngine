...
namespace Enigma::Editor {
	...
	template<typename T, typename ...Args> inline T& Entity::CreateComponent(Args && ...args) {
	...
	template<typename... Comps> inline bool Entity::HasComponents() const {
		return m_Scene->m_ECS->HasComponents<Comps...>(m_EntityID);
	}
}